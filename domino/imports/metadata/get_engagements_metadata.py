...
class GetEngagementsMetadata():
    def __init__(self,input_json):
        self.input_json=input_json

    @property
    def count(self):
        return self.input_json['count']

    @property
    def next(self):
        return self.input_json['next']

    @property
    def previous(self):
        return self.input_json['previous']

    @property
    def results(self):
        return self.input_json['results']


class GetEngagementsResultsMetadata():
    def __init__(self,input_json):
        self.input_json=input_json
...
if __name__ == '__main__':
    j={'count': 0, 'next': None, 'previous': None, 'results': []}
    ...
    r={
			...
			"reason": "null",
			"updated": "2022-10-12T18:15:01.840204Z",
    ...
    base_helper.iter_dict_into_properties(r)